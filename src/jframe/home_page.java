...
public class home_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1360, 10));

        jPanel1.setBackground(new java.awt.Color(0, 204, 204));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICON/READING (1).png"))); // NOI18N
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICON/images (1).jpeg"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 200, 300, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICON/Screenshot_2.jpg"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 380, 410, 290));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICON/wertwert.jpeg"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 0, 280, 190));
