...
String full_address ;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 350, 20));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 2, 18)); // NOI18N
        jLabel2.setText("hello dear  student welcome to varify page.");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 340, 50));

        verify_nidbirthtf.setPlaceholder("Enter Your NID/Birth Number :");
        jPanel1.add(verify_nidbirthtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 250, 40));
        ...
        jPanel1.add(verify_bod, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 250, -1));

        phonel.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        phonel.setText("Phone :");
        jPanel1.add(phonel, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 190, 100, 30));

        emaill.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        emaill.setText("Email :");
        jPanel1.add(emaill, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, 100, 30));

        nidl.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        nidl.setText("Nid/Birth No: ");
        jPanel1.add(nidl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 310, 100, 30));

        fullnametf.setEditable(false);
        fullnametf.setBackground(new java.awt.Color(153, 255, 204));
        ...
        jPanel1.add(fullnamel, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 100, 30));

        bodl.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        bodl.setText("Date of birth :");
        jPanel1.add(bodl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 350, 100, 30));

        institutel.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        institutel.setText("Institute/Office :");
        jPanel1.add(institutel, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 390, 100, 30));

        insidl.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        insidl.setText("ID of institute/office :");
        jPanel1.add(insidl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 430, 130, 30));

        fulladdressl.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        fulladdressl.setText("Full Address :");
        jPanel1.add(fulladdressl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 470, 100, 30));

        genderl.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        genderl.setText("Gender :");
        jPanel1.add(genderl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 270, 100, 30));

        useridl.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        useridl.setText("User ID :");
        jPanel1.add(useridl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 110, 100, 30));

        useridtf.setEditable(false);
        useridtf.setBackground(new java.awt.Color(153, 255, 204));
        ...
        jPanel1.add(idofinstitute, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 430, 240, 30));

        phonetf.setEditable(false);
        phonetf.setBackground(new java.awt.Color(153, 255, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(verify_student.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new verify_student().setVisible(true);
            }
        });
    }
