...
public class contact_with_boss extends javax.swing.JFrame {
    int id ;
    
    public contact_with_boss(int id){
        initComponents();
        this.id = id;
        set_profile();
    ...
    private void initComponents() {
        ...
        label1.setText("contact with boss");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contact_with_boss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
