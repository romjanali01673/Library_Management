...
public class Custom_Opration extends javax.swing.JFrame {
    int id;

    public Custom_Opration(int id) {
        this.id = id;
        initComponents();
        set_profile();     
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Visiable On Next Update.");
        ...
        CUSTOM_OPRATION.setBackground(new java.awt.Color(51, 0, 255));
...
public static void main(String [] args){
    Custom_Opration x = new Custom_Opration(345);
    x.setVisible(true);
}}
