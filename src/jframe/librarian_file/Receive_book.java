...
public class Receive_book extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICON/icons8_Secured_Letter_50px.png"))); // NOI18N
        ...
        MENU_BAR.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 0, 140, 50));
    ...
    private void readingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_readingMouseClicked
        Receive_book ac = new Receive_book(id);
        ac.setVisible(true);
        this.dispose();
