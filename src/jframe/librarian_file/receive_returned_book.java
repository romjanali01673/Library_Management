...
public class receive_returned_book extends javax.swing.JFrame {
    int id;

    public receive_returned_book(int id) {
        this.id = id;
        initComponents();
        set_profile();
    ...
    private void readingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_readingMouseClicked
            receive_returned_book ac = new receive_returned_book(id);
            ac.setVisible(true);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(receive_returned_book.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
